						...
						<ul class="navbar-nav">
							<c:choose>
								<c:when test="${principal == null}">
									...
									<li class="nav-item"><a class="nav-link" href="/admin/login">관리자로그인</a></li>
								</c:when>
								...
								<c:otherwise>
									...
									<li class="nav-item"><a class="nav-link" href="/users">유저목록</a></li>
									<li class="nav-item"><a class="nav-link" href="/users/orders/list">전체주문목록</a></li>
									<li class="nav-item"><a class="nav-link" href="/logout">로그아웃</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
